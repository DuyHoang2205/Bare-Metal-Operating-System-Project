...
void drawStringCentered(int y, char *str, unsigned int attr, int zoom, int screenWidth) {
    int strLength = strlen(str);                   // Get the length of the string
    int textWidth = strLength * FONT_WIDTH * zoom; // Calculate the width of the text

    // Calculate the starting x coordinate to center the text horizontally
    int x = (screenWidth - textWidth) / 2;

    // Call drawString with the calculated x coordinate and provided y coordinate
    drawString(x, y, str, attr, zoom);
}
